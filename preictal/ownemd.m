...
%   variable containing a vector. When X is a vector, IMF is a 2D matrix
%   where each data column stores an extracted intrinsic mode function, and
%   RESIDUAL is a column vector storing the residual. When X is a
%   timetable, the returned IMF is a timetable and RESIDUAL is a timetable
%   with one variable.
%
